...
})({"8BwaG":[function(require,module,exports) {
 ...
 */ const controlClock = function() {
    _model.setClock();
    (0, _viewJsDefault.default).calcRotation(+_model.state.secondRatio, +_model.state.minuteRatio, +_model.state.hourRatio);
};
setInterval(controlClock, 1000);
controlClock();

},{"core-js/modules/web.immediate.js":"49tUX","./model":"Py0LO","./view.js":"2GA9o","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
},{}]},["8BwaG","1GgH0"], "1GgH0", "parcelRequire98fc")
